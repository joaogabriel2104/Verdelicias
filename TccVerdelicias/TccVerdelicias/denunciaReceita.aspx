<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="denunciaReceita.aspx.cs" Inherits="TccVerdelicias.denuncia" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="stylesheet" href="css/estiloDenunciaReceita.css">
                    ...
                    <div class="conteudo1">
                        <div class="espacoDescricao"></div>
                            <div class="fotos">
                                ...
                                <div class="descReceita">
                                    <p><strong>Nome:</strong> <asp:Literal ID="litNomeReceita" runat="server"></asp:Literal></p>
                                    <p><strong>Data:</strong> <asp:Literal ID="litDataReceita" runat="server"></asp:Literal></p>   
                                    <p><strong>Criador:</strong> <asp:Literal ID="litCriadorReceita" runat="server"></asp:Literal></p>
                                </div>
                            </div>
