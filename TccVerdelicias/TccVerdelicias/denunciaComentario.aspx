<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="denunciaComentario.aspx.cs" Inherits="TccVerdelicias.denunciaComentario" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Verdelícias | Denúncia</title>
    <link rel="stylesheet" href="css/estilo.css">
    <link rel="stylesheet" href="css/estiloDenunciaComentario.css">
    ...
    <form id="form1" runat="server">
        ...
        <section class="ultimaSection primeiraSection">
            <div id="backCinza">
                ...
                <div class="conteudos">
                    <div class="conteudo1">
                        <div class="espacoDescricao"></div>
                            <div class="fotos">
                                <asp:Literal ID="litComentario" runat="server"></asp:Literal>
                                <div class="descPerfilEImagem">
                                    <div class="imagemPerfil">
                                        <asp:Literal ID="litImagemPerfil" runat="server"></asp:Literal>
                                    </div>
                                    <div class="descPerfil">
                                        <p><strong>Comentário:</strong> <asp:Literal ID="litDescricaoComentario" runat="server"></asp:Literal></p>
                                        <p><strong>Nome:</strong> <asp:Literal ID="litNomePerfil" runat="server"></asp:Literal></p>
                                        <p><strong>Usuário:</strong> <asp:Literal ID="litUserPerfil" runat="server"></asp:Literal></p>
                                        <p><strong>Data:</strong> <asp:Literal ID="litDataComentario" runat="server"></asp:Literal></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="conteudo1">
                        <div class="espacoDescricao"></div>
                        <p>Descrição:</p>
                        <asp:TextBox ID="txtDenuncia" class="descricaoDenuncia" TextMode="MultiLine" runat="server"></asp:TextBox>
                        <asp:Literal ID="litValidacao" runat="server"></asp:Literal>
                    </div>
                </div>
                <div Class="posicaoBotaoDenunciar">
                    <asp:Button ID="btnDenunciar" runat="server" Text="Enviar" OnClick="btnDenunciar_Click" />
                </div>
            </div>
        </section>
