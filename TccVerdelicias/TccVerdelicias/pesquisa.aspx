<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pesquisa.aspx.cs" Inherits="TccVerdelicias.pesquisa" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section class="primeiraSection ultimaSection">
            <div class="areaSegura">
                <h1><asp:Literal ID="litResultadosPara" runat="server"></asp:Literal></h1>
                <div class="conteudosReceitas">
                    <asp:Literal ID="litPesquisa" runat="server"></asp:Literal>
                </div>
            </div>
        </section>
