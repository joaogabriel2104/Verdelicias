<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="denunciaUsuario.aspx.cs" Inherits="TccVerdelicias.denunciaPerfil" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="stylesheet" href="css/estiloDenunciaUsuario.css">
                        ...
                        <div class="espacoDescricao"></div>
                            <div class="fotos">
                                ...
                                <div class="descPerfil">
                                    ...
                                    <p><strong>User:</strong> <asp:Literal ID="litUser" runat="server"></asp:Literal></p>
                                </div>
                            </div>
